...
rec=TransformerEncoder(train_path, transformer_config='bert-base-uncased')
...
master_u_feats=np.load(path+"u_feats.npy",allow_pickle=True).item()
...
run_experiments(configs,"models/citeulike/bert/bert_finetune")
