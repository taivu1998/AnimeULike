...
class DropoutNet(nn.Module):
    ...
    def forward(self,u,v,u_phi,v_phi,u_inds,v_inds,y,eval=False):
        ...
        #DROPOUT OR ZERO REPLACE?
        u_mask=torch.rand_like(u[:,:1])<self.user_drop_p
        u=u_mask*u
...
#@title Load cache
import json
VAR_NAMES=['u_dict','v_dict','val_v_dict','u_feats','weighted_u_feats','v_feats','val_v_feats']
for j in VAR_NAMES:
...
run_experiments(configs,"models/citeulike/uphi/weighted_u_feats/{}".format(mode))
