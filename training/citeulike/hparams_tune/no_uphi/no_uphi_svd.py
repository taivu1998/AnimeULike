...
config={#printed to save the model
    "hidden_dims":[[500]],
    "latent_dim":[200],#FIX
    "anime_dim":[300 if mode=="tfidf" else 774],#FIX
    "user_transform_p":[0.0],
    "item_drop_p":[0.5],
    "activation":["tanh"],
    "pos_neg_ratio":[5.5,6,6.5,7],
...
def train(dn,optimizer,num_epochs=100,cont=-1,num_accumulation_steps=NUM_ACCUMULATION_STEPS,save_every=1,metric_every=500*NUM_ACCUMULATION_STEPS,save_path=""):
    ...
    if os.path.isfile("{}_metrics.txt".format(save_path)):
        os.remove("{}_metrics.txt".format(save_path))
...
run_experiments(configs,"models/citeulike/no_uphi/svd_avg/{}".format(mode))
