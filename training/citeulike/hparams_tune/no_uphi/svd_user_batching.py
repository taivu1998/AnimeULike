...
def train(dn,optimizer,num_epochs=100,cont=-1,num_accumulation_steps=NUM_ACCUMULATION_STEPS,save_every=1,metric_every=500*NUM_ACCUMULATION_STEPS,save_path=""):
    ...
    for epoch in range(cont+1,num_epochs):
        ...
        uaid=UserAnimePermuteID(u_dict,v_dict,u_feats,v_feats,n_scores_user=dn.n_score_users,pos_neg_ratio=dn.pos_neg_ratio,user_transform_p=dn.user_transform_p)
        ...
        val_uaid=UserAnimePermuteID(u_dict,val_v_dict,u_feats,val_v_feats,dn.n_score_users,pos_neg_ratio=dn.pos_neg_ratio,user_transform_p=dn.user_transform_p)
...
run_experiments(configs,"models/citeulike/no_uphi/svd_batching/{}".format(mode))
