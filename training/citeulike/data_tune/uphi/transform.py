...
class UserAnimeID(Dataset):
    def __init__(self,u_dict,v_dict,u_feats,v_feats,user_drop_p=0.5):
        self.V_dict=v_dict
        self.U_dict=u_dict
        self.V_feats=v_feats 
        self.U_feats=u_feats
...
class UserAnimeCacheID(UserAnimeID):
    def __init__(self,u_dict,v_dict,u_feats,v_feats,user_drop_p=0.5):
        super().__init__(u_dict,v_dict,u_feats,v_feats,user_drop_p)
...
run_experiments(configs,"models/citeulike/uphi/transform_test/{}".format(mode))
